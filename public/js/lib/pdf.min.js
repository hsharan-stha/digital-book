    ...
    return (function (e) {
        ...
        function (e, t, r) {
            ...
            t.addLinkAttributes = function addLinkAttributes(
                ...
                e.target = l;
                e.rel =
                    "string" == typeof s ? s : "noopener noreferrer nofollow";
            };
            ...
            t.DOMCanvasFactory = class DOMCanvasFactory extends (
                BaseCanvasFactory
            ) {
            ...
            t.DOMCMapReaderFactory = class DOMCMapReaderFactory extends (
                ...
                _fetchData(e, t) {
                    return isFetchSupported() &&
                        isValidFetchUrl(e, document.baseURI)
        ...
        function (module, exports, __w_pdfjs_require__) {
            ...
            function getDocument(e) {
                ...
                "boolean" != typeof n.disableAutoFetch &&
            ...
            class PDFPageProxy {
                ...
                getAnnotations({ intent: e = null } = {}) {
                    if (
                        ...
                        this.annotationsPromise =
                            this._transport.getAnnotations(this._pageIndex, e);
                        this.annotationsIntent = e;
                    }
                ...
                _abortOperatorList({
                    ...
                    if (e.streamReader) {
                        ...
                        e.streamReader.cancel(
                            new _util.AbortException(t && t.message)
                        );
                        e.streamReader = null;
                        if (!this._transport.destroyed) {
                            for (const [t, r] of this._intentStates)
                                ...
                                for (const t in e) {
                                    ...
                                    if (void 0 !== r.value)
                                        if ("function" != typeof r.value)
                                            ...
                                            throw new Error(
                                                "LoopbackPort.postMessage - cannot clone: " +
                                                    e[t]
                                            );
                                }
                                return s;
            ...
            class WorkerTransport {
                    ...
                    e.on("DocException", function (e) {
                        ...
                        switch (e.name) {
                            ...
                            case "UnknownErrorException":
                                r = new _util.UnknownErrorException(
                                    e.message,
                                    e.details
                                );
                        }
                        ...
                        if (!this.commonObjs.has(r))
                            switch (n) {
                                case "Font":
                                    ...
                                    const i = new _font_loader.FontFaceObject(
                                        s,
                                        {
                                            isEvalSupported: t.isEvalSupported,
                                            disableFontFace: t.disableFontFace,
                ...
                startCleanup() {
                    return this.messageHandler
                        ...
                        .then(() => {
                            for (
                                let e = 0, t = this.pageCache.length;
                                e < t;
                                e++
                            ) {
        ...
        function (e, t, r) {
            ...
            class BaseFontLoader {
                        ...
                        if (t) {
                            ...
                            try {
                                ...
                                this._onUnsupportedFeature({
                                    featureId:
                                        n.UNSUPPORTED_FEATURES
                                            .errorFontLoadNative,
                                });
                                (0, n.warn)(
                                    `Failed to load font '${t.family}': '${r}'.`
                                );
                                e.disableFontFace = !0;
                                throw r;
                            }
                ...
                get isFontLoadingAPISupported() {
                    const e =
                        void 0 !== this._document && !!this._document.fonts;
            ...
            t.FontLoader = s = class GenericFontLoader extends BaseFontLoader {
                ...
                _prepareFontLoadEvent(e, t, r) {
                    ...
                    s < c.length &&
                        (d = (d - 1482184792 + int32(c + "XXX", s)) | 0);
                ...
                getPathGenerator(e, t) {
                    ...
                    try {
                        ...
                        this._onUnsupportedFeature &&
                            this._onUnsupportedFeature({
                                featureId:
                                    n.UNSUPPORTED_FEATURES.errorFontGetPath,
                            });
                        (0, n.warn)(
        ...
        function (e, t, r) {
            ...
            function addContextCurrentTransform(e) {
                if (!e.mozCurrentTransform) {
                    ...
                    e.setTransform = function ctxSetTransform(
                        t,
                        r,
                        n,
                        s,
            ...
            var i = (function CanvasExtraStateClosure() {
                    ...
                    CanvasExtraState.prototype = {
                        ...
                        setCurrentPoint:
                            function CanvasExtraState_setCurrentPoint(e, t) {
                                this.x = e;
                                this.y = t;
                            },
                    };
                ...
                o = (function CanvasGraphicsClosure() {
                    ...
                    function putBinaryImageData(e, t, r = null) {
                        ...
                        if (t.kind === n.ImageKind.GRAYSCALE_1BPP) {
                            var C = m.byteLength,
                                ...
                                P = (h + 7) >> 3,
                                k = 4294967295,
                                R = n.IsLittleEndianCached.value
                                    ? 4278190080
                                    : 255;
                            v &&
                                255 === v[0] &&
                            ...
                            !(function genericComposeSMask(
                                ...
                                o =
                                    "Luminosity" === s
                                        ...
                                        : composeSMaskAlpha;
                                for (
                                    var u = Math.min(n, Math.ceil(1048576 / r)),
                                        p = 0;
                                    p < n;
                                    p += u
                                ) {
                    ...
                    CanvasGraphics.prototype = {
                        beginDrawing({
                            ...
                            this.ctx.restore();
                            if (r) {
                                var i = this.cachedCanvases.getCanvas(
                                    "transparent",
                                    s,
                                    a,
                                    !0
                        ...
                        setMiterLimit: function CanvasGraphics_setMiterLimit(
                            e
                        ) {
                        ...
                        beginSMaskGroup:
                            function CanvasGraphics_beginSMaskGroup() {
                                var e = this.current.activeSMask,
                                    ...
                                    s = this.cachedCanvases.getCanvas(
                                        n,
                                        t,
                                        r,
                                        !0
                        ...
                        constructPath: function CanvasGraphics_constructPath(
                            e,
                            t
                        ) {
                            for (
                            ...
                            if (this.contentVisible)
                                if (
                                    ...
                                    const e = t.mozCurrentTransform,
                                        s =
                                            n.Util.singularValueDecompose2dScale(
                                                e
                                            )[0];
                        ...
                        setCharSpacing: function CanvasGraphics_setCharSpacing(
                            e
                        ) {
                            this.current.charSpacing = e;
                        },
                        setWordSpacing: function CanvasGraphics_setWordSpacing(
                            e
                        ) {
                        ...
                        setFont: function CanvasGraphics_setFont(e, t) {
                            ...
                            (0 !== s.fontMatrix[0] && 0 !== s.fontMatrix[3]) ||
                                (0, n.warn)(
                                    "Invalid font matrix for font " + e
                                );
                            if (t < 0) {
                                t = -t;
                                s.fontDirection = -1;
                        ...
                        setTextRenderingMode:
                            function CanvasGraphics_setTextRenderingMode(e) {
                        ...
                        setLeadingMoveText:
                            function CanvasGraphics_setLeadingMoveText(e, t) {
                                this.setLeading(-t);
                                this.moveText(e, t);
                            },
                        setTextMatrix: function CanvasGraphics_setTextMatrix(
                            ...
                            this.current.textMatrixScale = Math.sqrt(
                                e * e + t * t
                            );
                            this.current.x = this.current.lineX = 0;
                            this.current.y = this.current.lineY = 0;
                        ...
                        paintChar(e, t, r, s) {
                            var a = this.ctx,
                                ...
                                d = !!(
                                    l & n.TextRenderingMode.ADD_TO_PATH_FLAG
                                );
                        ...
                        showType3Text: function CanvasGraphics_showType3Text(
                            e
                        ) {
                            var t,
                                r,
                        ...
                        getColorN_Pattern:
                            function CanvasGraphics_getColorN_Pattern(e) {
                                var t;
                        ...
                        setStrokeRGBColor:
                            function CanvasGraphics_setStrokeRGBColor(e, t, r) {
                                var s = n.Util.makeCssRgb(e, t, r);
                                this.ctx.strokeStyle = s;
                                this.current.strokeColor = s;
                            },
                        setFillRGBColor:
                            function CanvasGraphics_setFillRGBColor(e, t, r) {
                                var s = n.Util.makeCssRgb(e, t, r);
                        ...
                        beginGroup: function CanvasGraphics_beginGroup(e) {
                            if (this.contentVisible) {
                                ...
                                e.smask &&
                                    (u +=
                                        "_smask_" + (this.smaskCounter++ % 2));
                                var p = this.cachedCanvases.getCanvas(
                                        u,
                                        l,
                                        c,
                                        !0
                        ...
                        beginAnnotation:
                            function CanvasGraphics_beginAnnotation(e, t, r) {
                                this.save();
                                resetCtxToDefault(this.ctx);
                                this.current = new i();
                            ...
                            function CanvasGraphics_paintImageMaskXObject(e) {
                                if (this.contentVisible) {
                                    ...
                                    if (i && i.compiled) i.compiled(t);
                                        ...
                                        var o = this.cachedCanvases.getCanvas(
                                                "maskCanvas",
                                                r,
                                                n
                                            ),
                        ...
                        paintImageXObject:
                            function CanvasGraphics_paintImageXObject(e) {
                                ...
                                if (this.contentVisible) {
                                    ...
                                    for (
                                        ...
                                        u > 2 &&
                                            g > 1 &&
                                            (u /= g / (A = Math.ceil(g / 2)));
                                        (p = (a = this.cachedCanvases.getCanvas(
                                            m,
                                            _,
                                            A
                        ...
                        beginMarkedContent:
                            function CanvasGraphics_beginMarkedContent(e) {
                        ...
                        getCanvasPosition:
                            function CanvasGraphics_getCanvasPosition(e, t) {
                    ...
                    for (var l in n.OPS)
                        CanvasGraphics.prototype[n.OPS[l]] =
                            CanvasGraphics.prototype[l];
        ...
        function (e, t, r) {
            ...
            var a = (function createMeshCanvasClosure() {
                ...
                return function createMeshCanvas(e, t, r, n, s, a, i, o) {
                    ...
                    if (o.isEnabled) {
                        ...
                        (c = i.getCanvas("mesh", v, C, !1)).context.drawImage(
                            l,
                            2,
                            2
                        );
                ...
                fromIR: function Mesh_fromIR(e) {
                    ...
                    return {
                        ...
                        getPattern: function Mesh_getPattern(e, h, d) {
                            ...
                            var u;
                            if (d)
                                u = n.Util.singularValueDecompose2dScale(
                                    e.mozCurrentTransform
                                );
                            else {
                                u = n.Util.singularValueDecompose2dScale(
                                ...
                                if (o) {
                                    var p =
                                        n.Util.singularValueDecompose2dScale(o);
                                    u = [u[0] * p[0], u[1] * p[1]];
                                }
                            }
                            var f = a(
            ...
            var i = (function TilingPatternClosure() {
                ...
                TilingPattern.prototype = {
                    createPatternCanvas:
                        function TilinPattern_createPatternCanvas(e) {
                            ...
                            var h = r[0],
                                ...
                                g = n.Util.singularValueDecompose2dScale(
                                    this.baseTransform
                                ),
                                m = [f[0] * g[0], f[1] * g[1]],
                            ...
                            switch (s) {
                                ...
                                default:
                                    throw new n.FormatError(
                                        "Unsupported paint type: " + s
                                    );
                            }
                        },
                    getPattern: function TilingPattern_getPattern(e, t) {
                        (e = this.ctx).setTransform.apply(
                            e,
                            this.baseTransform
                        );
        ...
        function (e, t, r) {
            ...
            function wrapReason(e) {
                ...
                switch (e.name) {
                    ...
                    case "UnknownErrorException":
                        return new n.UnknownErrorException(
                            e.message,
                            e.details
                        );
                    default:
                ...
                _processStreamMessage(e) {
                    ...
                    switch (e.stream) {
                        ...
                        case c:
                            ...
                            this.streamControllers[t].controller.enqueue(
                                e.chunk
                            );
                            break;
                        case l:
                    ...
                    return e
                        ...
                        .replace(/>\\376\\377([^<]+)/g, function (e, t) {
                            ...
                            for (let e = 0, t = r.length; e < t; e += 2) {
                                const t =
                                    256 * r.charCodeAt(e) + r.charCodeAt(e + 1);
                                n +=
                                    t >= 32 &&
                                    t < 127 &&
                                    60 !== t &&
                    ...
                    for (let e = 0, t = n.length; e < t; e++) {
                        ...
                        if ("rdf:description" === t.nodeName.toLowerCase())
                            for (let e = 0, r = t.childNodes.length; e < r; e++)
                                if (
                                    "#text" !==
                                    t.childNodes[e].nodeName.toLowerCase()
                                ) {
            ...
            var s = (function WebGLUtilsClosure() {
                function loadShader(e, t, r) {
                    ...
                    if (!e.getShaderParameter(n, e.COMPILE_STATUS)) {
                        ...
                        throw new Error(
                            "Error during shader compilation: " + s
                        );
                    }
                    return n;
                }
                ...
                function createProgram(e, t) {
                    for (
                        var r = e.createProgram(), n = 0, s = t.length;
                        n < s;
                        ++n
                    )
                    ...
                    composeSMask: function composeSMask(n, s, a) {
                        ...
                        r ||
                            (function initSmaskGL() {
                                ...
                                i.gl = s;
                                i.canvas = n;
                                i.resolutionLocation = s.getUniformLocation(
                                    a,
                                    "u_resolution"
                                );
                                i.positionLocation = s.getAttribLocation(
                                    a,
                                    "a_position"
                                );
                                i.backdropLocation = s.getUniformLocation(
                                    a,
                                    "u_backdrop"
                                );
                                i.subtypeLocation = s.getUniformLocation(
                                    a,
                                    "u_subtype"
                                );
                    ...
                    drawFigures: function drawFigures(r, s, a, i, o) {
                        n ||
                            (function initFiguresGL() {
                                ...
                                i.scaleLocation = s.getUniformLocation(
                                    a,
                                    "u_scale"
                                );
                                i.offsetLocation = s.getUniformLocation(
                                    a,
                                    "u_offset"
                                );
                                i.positionLocation = s.getAttribLocation(
                                ...
                                i.colorLocation = s.getAttribLocation(
                                    a,
                                    "a_color"
                                );
                                n = i;
        ...
        function (e, t, r) {
            ...
            class AnnotationElement {
                ...
                _createContainer(e = !1) {
                    ...
                    if (!e && t.borderStyle.width > 0) {
                        ...
                        if (
                            t.borderStyle.style !==
                            s.AnnotationBorderStyleType.UNDERLINE
                        ) {
            ...
            class TextAnnotationElement extends AnnotationElement {
                constructor(e) {
                    super(
                        e,
                        !!(e.data.hasPopup || e.data.title || e.data.contents)
                    );
                }
                render() {
            ...
            class CheckboxWidgetAnnotationElement extends WidgetAnnotationElement {
                ...
                render() {
                    const e = this.annotationStorage,
                        t = this.data,
                        r = t.id,
                        n = e.getOrCreateValue(
                            r,
                            t.fieldValue && "Off" !== t.fieldValue
                        );
            ...
            class PopupAnnotationElement extends AnnotationElement {
                ...
                render() {
                    ...
                    this.container.style.transformOrigin = `-${n + s}px -${
                        t.style.top
                    }`;
                ...
                render() {
                    ...
                    if (r) {
                        const e = 0.7 * (255 - r[0]) + r[0],
                            n = 0.7 * (255 - r[1]) + r[1],
                            a = 0.7 * (255 - r[2]) + r[2];
                        t.style.backgroundColor = s.Util.makeCssRgb(
                            0 | e,
                            0 | n,
                            0 | a
                        );
                    ...
                    t.appendChild(a);
                    const i = n.PDFDateString.toDateObject(
            ...
            var n = r(2),
                s = (function renderTextLayerClosure() {
                    ...
                    function appendText(t, r, s) {
                        ...
                        var o = n.Util.transform(
                                t._viewport.transform,
                                r.transform
                            ),
                        ...
                        t.forEach(function (e) {
                            ...
                            for (i = t; i <= a; i++)
                                void 0 === (s = (n = r[i]).boundary).x2New
                                    ? s.x2 > e.x1
                                        ...
                                        : (s.x2New = l)
                                    : s.x2New > l &&
                                      (s.x2New = Math.max(l, s.x2));
                            var h = [],
                                d = null;
                            for (i = t; i <= a; i++) {
                                var u =
                                    (s = (n = r[i]).boundary).x2 > e.x2 ? s : e;
                            ...
                            for (i = t; i <= a; i++)
                                if (
                                    ...
                                    for (
                                        o = t - 1;
                                        !p && o >= 0 && r[o].start >= s.y1;
                                        o--
                                    )
                                        p = r[o].boundary === s;
                                    for (
                                        o = a + 1;
                                        !p && o < r.length && r[o].end <= s.y2;
                                        o++
                                    )
                                        p = r[o].boundary === s;
                    ...
                    TextLayerRenderTask.prototype = {
                        ...
                        expandTextDivs: function TextLayer_expandTextDivs(e) {
                            ...
                            const t = [],
                                r = [];
                            for (
                                var n = 0, s = this._textDivs.length;
                                n < s;
                                n++
                            ) {
                                ...
                                if (!a.isWhitespace)
                                    if (e) {
                                        ...
                                        r.length = 0;
                                        a.originalTransform &&
                                            t.push(a.originalTransform);
                                        if (a.paddingTop > 0) {
                                            r.push(a.paddingTop + "px");
                                            t.push(
                                                `translateY(${-a.paddingTop}px)`
                                            );
                                        } else r.push(0);
                                        a.paddingRight > 0
                                            ? r.push(
                                                  a.paddingRight / a.scale +
                                                      "px"
                                              )
                                            : r.push(0);
                                        a.paddingBottom > 0
                                        ...
                                        if (a.paddingLeft > 0) {
                                            r.push(
                                                a.paddingLeft / a.scale + "px"
                                            );
                                            t.push(
                                                `translateX(${
                                                    -a.paddingLeft / a.scale
                                                }px)`
                                            );
                                        } else r.push(0);
                                        s.style.padding = r.join(" ");
                                        t.length &&
                                            (s.style.transform = t.join(" "));
                                    } else {
        ...
        function (e, t, r) {
            ...
            t.SVGGraphics = SVGGraphics;
            {
                                    ...
                                    try {
                                        ...
                                        t =
                                            parseInt(process.versions.node) >= 8
                                                ? e
                                                : Buffer.from(e);
                                        const r = require("zlib").deflateSync(
                                            t,
                                            { level: 9 }
                                        );
                ...
                function pm(e) {
                    ...
                    return (
                        `matrix(${pf(e[0])} ${pf(e[1])} ${pf(e[2])} ${pf(
                            e[3]
                        )} ${pf(e[4])} ` +
                        pf(e[5]) +
                        ")"
                    ...
                    setGState(e) {
                        for (const [t, r] of e)
                            switch (t) {
                                ...
                                default:
                                    (0, n.warn)(
                                        "Unimplemented graphic state operator " +
                                            t
                                    );
                            }
                    }
            ...
            class BaseFullReader {
                ...
                _setReadableStream(e) {
                    ...
                    !this._isStreamingSupported &&
                        ...
                        this._error(
                            new n.AbortException("streaming is disabled")
                        );
                    this._storedError &&
        ...
        function (e, t, r) {
            ...
            t.createResponseStatusError = function createResponseStatusError(
                ...
                if (404 === e || (0 === e && t.startsWith("file:")))
                    return new n.MissingPDFException(
                        'Missing PDF "' + t + '".'
                    );
                return new n.UnexpectedResponseException(
            ...
            t.extractFilenameFromHeader = function extractFilenameFromHeader(
                e
            ) {
                    ...
                    fetch(
                        ...
                        .then((e) => {
                            if (!(0, s.validateResponseStatus)(e.status))
                                throw (0, s.createResponseStatusError)(
                                    e.status,
                                    r
                                );
                            ...
                            const getResponseHeader = (t) => e.headers.get(t),
                                { allowRangeRequests: t, suggestedLength: a } =
