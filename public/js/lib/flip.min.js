(function (f) {
    ...
    function R(a, b, c, d, e) {
        ...
        return j(
            Math.round(
                f * a.x + 3 * e * h * h * b.x + 3 * e * e * h * c.x + g * d.x
            ),
            Math.round(
                f * a.y + 3 * e * h * h * b.y + 3 * e * e * h * c.y + g * d.y
            )
        );
    }
    function j(a, b) {
    ...
    var y,
        ...
        g = {
            init: function (a) {
                ...
                this.paltau("display", a.display);
                "" !== a.direction && this.paltau("direction", a.direction);
                y && !t && a.acceleration && this.transform(E(0, 0, !0));
                for (c = 0; c < e.length; c++)
                    "1" != f(e[c]).attr("ignore") &&
                        this.paltau("addPage", e[c], ++b);
                f(this)
            ...
            center: function (a) {
                var b = this.data(),
                    c = f(this).paltau("size"),
                    d = 0;
                b.noCenter ||
                    ("double" == b.display &&
                        ((a = this.paltau("view", a || b.tpage || b.page)),
                        "ltr" == b.direction
                            ? a[0]
                                ? a[1] || (d += c.width / 4)
                                : (d -= c.width / 4)
            ...
            destroy: function () {
                ...
                if ("prevented" != s("destroying", this)) {
                    ...
                    for (
                        ...
                        this.paltau("removePage", b.totalPages);
            ...
            zoom: function (a) {
                ...
                if ("number" == typeof a) {
                    ...
                    if ("prevented" == s("zooming", this, [a, b.zoom]))
                        return this;
                    var c = this.paltau("size"),
                        d = this.paltau("view"),
                        e = 1 / b.zoom,
                        h = Math.round(c.width * e * a),
                        c = Math.round(c.height * e * a);
                    b.zoom = a;
                    f(this).paltau("stop").paltau("size", h, c);
                    b.opts.autoCenter && this.paltau("center");
                ...
                1 <= d[0] && d[1] <= e.totalPages
                    ? ((a = Math.floor(2)),
                      e.totalPages - d[1] > d[0]
                          ...
                          : ((c = Math.min(e.totalPages - d[1], a)),
                            (b = 2 * a - c)))
                    : (c = b = 5);
                return [
                    Math.max(1, d[0] - b),
                    Math.min(e.totalPages, d[1] + c),
                ];
            },
            _necessPage: function (a) {
                if (0 === a) return !0;
                var b = this.paltau("range");
                return (
                    this.data().pageObjs[a].hasClass("fixed") ||
                    (a >= b[0] && a <= b[1])
                );
            },
            ...
            removePage: function (a) {
                ...
                if ("*" == a)
                    ...
                    b.page > b.totalPages
                        ...
                        : (g._makeRange.call(this), this.paltau("update"));
                }
                return this;
            },
            ...
            display: function (a) {
                ...
                c &&
                    ...
                    this.paltau("size", a.width, a.height).paltau("update"));
                return this;
            },
            direction: function (a) {
                ...
                b.direction = a;
                b.done && this.paltau("size", f(this).width(), f(this).height());
                return this;
            },
            animating: function () {
            ...
            _missing: function (a) {
                ...
                if (!(1 > b.totalPages)) {
                    for (
                        var c = this.paltau("range", a), d = [], a = c[0];
                        a <= c[1];
                        a++
                    )
                ...
                if (!b.disabled && !b.destroying) {
                    ...
                    if (0 < a && a <= b.totalPages)
                        return (
                            a != b.page &&
                                (!b.done ||
                                -1 != f.inArray(a, this.paltau("view"))
            ...
            previous: function () {
                return this.paltau(
                    ...
                    Math.max(
                        1,
                        g._view.call(this, this.data().page).shift() - 1
                    )
                );
            },
            peel: function (a, b) {
            ...
            _flip: function (a) {
                ...
                a.paltau.trigger("paltau", [a.next]);
                a.paltau.data().opts.autoCenter && a.paltau.paltau("center", a.next);
            },
            ...
            update: function () {
                var a,
                    b = this.data();
                if (this.paltau("animating") && 0 !== b.pageMv[0]) {
                    var c,
                        d = this.paltau("calculateZ", b.pageMv),
                        e = this.paltau("corner"),
                        h = this.paltau("view"),
                        i = this.paltau("view", b.tpage);
                    for (a in b.pageWrap)
                        if (
                            n(a, b.pageWrap) &&
            ...
            _updateShadow: function () {
                ...
                for (var i = 0; i < c.pageMv.length && a[0] && a[1]; i++)
                    (a = this.paltau(
                        "view",
                        c.pages[c.pageMv[i]].data().f.opts.next
                    )),
                        (b = this.paltau("view", c.pageMv[i])),
                        (a[0] = a[0] && b[0]),
                        (a[1] = a[1] && b[1]);
                switch (
                    a[0]
                ...
                if (!this.paltau("animating"))
                    switch (d) {
                        ...
                        case 0:
                            b.pageWrap[a].css({
                                zIndex: 0,
                                display: b.pageObjs[a].hasClass("fixed")
                                    ? ""
                                    : "none",
                            });
                    }
            ...
            options: function (a) {
                ...
                var b = this.data();
                f.extend(b.opts, a);
                a.pages && this.paltau("pages", a.pages);
                a.page && this.paltau("page", a.page);
                a.display && this.paltau("display", a.display);
                a.direction && this.paltau("direction", a.direction);
                a.width && a.height && this.paltau("size", a.width, a.height);
                if (a.when)
                    for (var c in a.when)
        ...
        i = {
            ...
            _backGradient: function () {
                var a = this.data().f,
                    b = a.opts.paltau.data();
                if (
                    (b =
                        b.opts.gradients &&
                        ("single" == b.display ||
                            (2 != a.opts.page &&
                                a.opts.page != b.totalPages - 1))) &&
                    !a.bshadow
                )
            ...
            resize: function (a) {
                ...
                switch (b.effect) {
                    ...
                    case "sheet":
                        a &&
                            ((a = Math.round(
                                Math.sqrt(Math.pow(d, 2) + Math.pow(e, 2))
                            )),
                    ...
                    switch (a.effect) {
                        case "hard":
                            ...
                            a.wrapper = f("<div/>", l(0, 0, 2))
                                ...
                                .appendTo(c)
                                .prepend(this);
                            a.fpage = f("<div/>", l(0, 0, 1))
                                .css(d)
                                .appendTo(c);
                            b.opts.gradients &&
                                ((a.ashadow = f("<div/>", l(0, 0, 0))
                                    .hide()
                                    .appendTo(c)),
                        ...
                        case "sheet":
                            ...
                            a.fparent = a.opts.paltau.data().fparent;
                            a.fparent ||
                                ((d = f("<div/>", {
                                ...
                                d
                                    ...
                                    .appendTo(a.opts.paltau),
                                (a.opts.paltau.data().fparent = d),
                                (a.fparent = d));
                            this.css({
                                position: "absolute",
                                top: 0,
                            ...
                            a.wrapper = f(
                                "<div/>",
                                l(0, 0, this.css("z-index"))
                            )
                                .appendTo(c)
                                .prepend(this);
                            a.fwrapper = f(
                                "<div/>",
                                l(c.offset().top, c.offset().left)
                            )
                                .hide()
                                .appendTo(a.fparent);
                            a.fpage = f("<div/>", l(0, 0, 0, "visible"))
                                ...
                                .appendTo(a.fwrapper);
                            b.opts.gradients &&
                                (a.ashadow = f("<div/>", l(0, 0, 1)).appendTo(
                                    a.fpage
                                ));
                    ...
                    if (!f || !e.point || e.point.corner != a.corner)
                        if (
                            ((c =
                                "hover" == e.status ||
                                "peel" == e.status ||
                                e.opts.paltau.data().mouseAction
                                    ? a.corner
                                    : null),
                            (f = !1),
            ...
            turnPage: function (a) {
                var b = this,
                    c = this.data().f,
                    d = c.opts.paltau.data(),
                    a = {
                        corner: c.corner
                            ? c.corner.corner
                            : a || i._cAllowed.call(this)[0],
                    },
                    e =
                        c.point ||
                        i._c.call(
                            this,
                            a.corner,
                            c.opts.paltau ? d.opts.elevation : 0
                        ),
